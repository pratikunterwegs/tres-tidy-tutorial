...
\CommentTok{#>      id beak_length beak_width body_weight island }
\CommentTok{#>   <int>       <dbl>      <dbl>       <dbl> <chr>  }
\CommentTok{#> 1     1        4.94       1.94       10.8  Isabela}
\CommentTok{#> 2     2        5.02       2.00       15.4  Isabela}
\CommentTok{#> 3     3        4.92       1.91       15.0  Isabela}
\CommentTok{#> 4     4        5.16       2.02        8.51 Isabela}
\CommentTok{#> 5     5        5.03       1.93       14.9  Isabela}
\CommentTok{#> 6     6        4.92       2.18        8.41 Isabela}
...
\CommentTok{#> 1     1 Isabela beak_length  4.94}
\CommentTok{#> 2     1 Isabela beak_width   1.94}
\CommentTok{#> 3     1 Isabela body_weight 10.8 }
\CommentTok{#> 4     2 Isabela beak_length  5.02}
\CommentTok{#> 5     2 Isabela beak_width   2.00}
\CommentTok{#> 6     2 Isabela body_weight 15.4 }
...
\NormalTok{)}
\CommentTok{#> # A tibble: 100 x 5}
\CommentTok{#>      id island  beak_length beak_width body_weight}
\CommentTok{#>   <int> <chr>         <dbl>      <dbl>       <dbl>}
\CommentTok{#> 1     1 Isabela        4.94       1.94       10.8 }
\CommentTok{#> 2     2 Isabela        5.02       2.00       15.4 }
\CommentTok{#> 3     3 Isabela        4.92       1.91       15.0 }
\CommentTok{#> 4     4 Isabela        5.16       2.02        8.51}
\CommentTok{#> 5     5 Isabela        5.03       1.93       14.9 }
\CommentTok{#> 6     6 Isabela        4.92       2.18        8.41}
\CommentTok{#> # ... with 94 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   <int> <chr>   <chr>       <dbl>}
\CommentTok{#> 1     1 Isabela beak_length  4.94}
\CommentTok{#> 2     1 Isabela beak_width  NA   }
\CommentTok{#> 3     1 Isabela body_weight NA   }
\CommentTok{#> 4     2 Isabela beak_length NA   }
\CommentTok{#> 5     2 Isabela beak_width   2.00}
\CommentTok{#> 6     2 Isabela body_weight NA   }
\CommentTok{#> # ... with 294 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   <int> <chr>   <chr>       <dbl>}
\CommentTok{#> 1     1 Isabela beak_length  4.94}
\CommentTok{#> 2     2 Isabela beak_width   2.00}
\CommentTok{#> 3     3 Isabela beak_length  4.92}
\CommentTok{#> 4     3 Isabela beak_width   1.91}
\CommentTok{#> 5     4 Isabela beak_length  5.16}
\CommentTok{#> 6     4 Isabela body_weight  8.51}
...
\CommentTok{#>   <int> <chr>   <chr>         <dbl>}
\CommentTok{#> 1     1 Isabela beak_length    4.94}
\CommentTok{#> 2     1 Isabela beak_width  -999   }
\CommentTok{#> 3     1 Isabela body_weight -999   }
\CommentTok{#> 4     2 Isabela beak_length -999   }
\CommentTok{#> 5     2 Isabela beak_width     2.00}
\CommentTok{#> 6     2 Isabela body_weight -999   }
\CommentTok{#> # ... with 294 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>   <int> <chr>   <chr>       <dbl>}
\CommentTok{#> 1     1 Isabela beak_length  4.94}
\CommentTok{#> 2     1 Isabela beak_width   4.94}
\CommentTok{#> 3     1 Isabela body_weight  4.94}
\CommentTok{#> 4     2 Isabela beak_length  4.94}
\CommentTok{#> 5     2 Isabela beak_width   2.00}
\CommentTok{#> 6     2 Isabela body_weight  2.00}
\CommentTok{#> # ... with 294 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1     1 Isabela beak_length  4.94     8     7  2020}
\CommentTok{#> 2     1 Isabela beak_width  NA       19     7  2019}
\CommentTok{#> 3     1 Isabela body_weight NA       17    12  2019}
\CommentTok{#> 4     2 Isabela beak_length NA       20    12  2020}
\CommentTok{#> 5     2 Isabela beak_width   2.00    21    10  2020}
\CommentTok{#> 6     2 Isabela body_weight NA       23     2  2020}
\CommentTok{#> # ... with 294 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>      id island  variable    value date }
\CommentTok{#>   <int> <chr>   <chr>       <dbl> <chr>}
\CommentTok{#> 1     1 Isabela beak_length  4.94 8    }
\CommentTok{#> 2     1 Isabela beak_length  4.94 7    }
\CommentTok{#> 3     1 Isabela beak_length  4.94 2020 }
\CommentTok{#> 4     1 Isabela beak_width  NA    19   }
\CommentTok{#> 5     1 Isabela beak_width  NA    7    }
\CommentTok{#> 6     1 Isabela beak_width  NA    2019 }
...
\CommentTok{#>   island     variable   }
\CommentTok{#>   <chr>      <chr>      }
\CommentTok{#> 1 Isabela    beak_length}
\CommentTok{#> 2 Isabela    beak_width }
\CommentTok{#> 3 Isabela    body_weight}
\CommentTok{#> 4 Santa Cruz beak_length}
\CommentTok{#> 5 Santa Cruz beak_width }
\CommentTok{#> 6 Santa Cruz body_weight}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> # A tibble: 300 x 5}
\CommentTok{#>   island  variable       id value date      }
\CommentTok{#>   <chr>   <chr>       <int> <dbl> <chr>     }
\CommentTok{#> 1 Isabela beak_length     1  4.94 8-7-2020  }
\CommentTok{#> 2 Isabela beak_length     2 NA    20-12-2020}
\CommentTok{#> 3 Isabela beak_length     3  4.92 20-4-2019 }
\CommentTok{#> 4 Isabela beak_length     4  5.16 5-3-2020  }
\CommentTok{#> 5 Isabela beak_length     5  5.03 1-4-2019  }
\CommentTok{#> 6 Isabela beak_length     6  4.92 2-3-2019  }
\CommentTok{#> # ... with 294 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> [1] Pratik Theo   Raph  }
\CommentTok{#> Levels: Pratik Theo Raph}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> [1] Pratik Theo   Raph  }
\CommentTok{#> Levels: Theo Raph Pratik}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=\textwidth]{TRES-Tidy-Tutorial_files/figure-latex/unnamed-chunk-59-1} \end{center}
...
However, the functionality of \texttt{for} loops is spread over the \texttt{map} family of functions from \texttt{purrr}.
...
These reasons, as well as how \texttt{map} is different from \texttt{for} and \texttt{lapply} are best explained in the \textbf{\href{https://adv-r.hadley.nz/functionals.html}{Advanced R Book}}.
...
\CommentTok{#>    mpg cyl disp  hp drat   wt qsec vs am gear carb}
\CommentTok{#> 1 22.8   4  108  93 3.85 2.32 18.6  1  1    4    1}
\CommentTok{#> 2 24.4   4  147  62 3.69 3.19 20.0  1  0    4    2}
\CommentTok{#> 3 21.0   6  160 110 3.90 2.62 16.5  0  1    4    4}
\CommentTok{#> 4 21.0   6  160 110 3.90 2.88 17.0  0  1    4    4}
\CommentTok{#> 5 18.7   8  360 175 3.15 3.44 17.0  0  0    3    2}
\CommentTok{#> 6 14.3   8  360 245 3.21 3.57 15.8  0  0    3    4}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>    mpg cyl disp hp drat   wt qsec vs am gear carb mpg1 cyl1 disp1 hp1 drat1}
\CommentTok{#> 1 22.8   4  108 93 3.85 2.32 18.6  1  1    4    1   21    6   160 110   3.9}
\CommentTok{#> 2 24.4   4  147 62 3.69 3.19 20.0  1  0    4    2   21    6   160 110   3.9}
\CommentTok{#>    wt1 qsec1 vs1 am1 gear1 carb1 mpg2 cyl2 disp2 hp2 drat2  wt2 qsec2 vs2 am2}
\CommentTok{#> 1 2.62  16.5   0   1     4     4 18.7    8   360 175  3.15 3.44  17.0   0   0}
\CommentTok{#> 2 2.88  17.0   0   1     4     4 14.3    8   360 245  3.21 3.57  15.8   0   0}
\CommentTok{#>   gear2 carb2}
\CommentTok{#> 1     3     2}
\CommentTok{#> 2     3     4}
\end{Highlighting}
\end{Shaded}
...
\texttt{map\_at} and \texttt{map\_if} work like other \texttt{*\_at} and \texttt{*\_if} functions.

Here, \texttt{map\_if} is used to run a linear model only on those dataframes which have sufficient data. The predicate is specified by \texttt{.p}.
...
\texttt{map\_at} works on specific elements of a list or vector. Come back to this, it's not particularly useful.

\hypertarget{more-map-variants}{%
\section{\texorpdfstring{More \texttt{map} variants}{More map variants}}\label{more-map-variants}}

\texttt{map} also has variants along the axis of how many elements are operated upon. \texttt{map2} operates on two vectors or list-like elements, and returns a single list as output.
...
\KeywordTok{map2}\NormalTok{(}\DataTypeTok{.x =} \DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{, }
...
The way \texttt{reduce} works is to take the first element, \texttt{a} in the example, and find its intersection with \texttt{b}, and to take the result and find its intersection with \texttt{c}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{this_list =}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{a =} \DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, }\DataTypeTok{b =} \DecValTok{3}\OperatorTok{:}\DecValTok{6}\NormalTok{, }\DataTypeTok{c =} \DecValTok{3}\OperatorTok{:}\DecValTok{10}\NormalTok{)}

\KeywordTok{reduce}\NormalTok{(this_list, intersect)}
\CommentTok{#> [1] 3}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> $`3`$`4`}
\CommentTok{#>                mpg cyl disp hp drat   wt qsec vs am gear carb}
\CommentTok{#> Toyota Corona 21.5   4  120 97  3.7 2.46   20  1  0    3    1}
\CommentTok{#> }
\CommentTok{#> }
\CommentTok{#> $`4`}
\CommentTok{#> $`4`$`4`}
