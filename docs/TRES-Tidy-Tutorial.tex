...
##    <int>       <dbl>      <dbl>       <dbl> <chr>  
##  1     1        5.19       1.97        7.66 Isabela
##  2     2        5.03       2.05       10.6  Isabela
##  3     3        5.09       1.95       12.4  Isabela
##  4     4        5.03       1.93       14.8  Isabela
##  5     5        5.10       1.98       10.6  Isabela
##  6     6        5.06       2.08       19.9  Isabela
##  7     7        5.08       1.82       15.6  Isabela
##  8     8        5.02       1.96        4.30 Isabela
##  9     9        4.92       2.04        9.48 Isabela
## 10    10        5.08       1.96        6.51 Isabela
## # ... with 90 more rows
\end{verbatim}
...
##    <int> <chr>   <chr>       <dbl>
##  1     1 Isabela beak_length  5.19
##  2     1 Isabela beak_width   1.97
##  3     1 Isabela body_weight  7.66
##  4     2 Isabela beak_length  5.03
##  5     2 Isabela beak_width   2.05
##  6     2 Isabela body_weight 10.6 
##  7     3 Isabela beak_length  5.09
##  8     3 Isabela beak_width   1.95
##  9     3 Isabela body_weight 12.4 
## 10     4 Isabela beak_length  5.03
## # ... with 290 more rows
\end{verbatim}
...
##    <int> <chr>         <dbl>      <dbl>       <dbl>
##  1     1 Isabela        5.19       1.97        7.66
##  2     2 Isabela        5.03       2.05       10.6 
##  3     3 Isabela        5.09       1.95       12.4 
##  4     4 Isabela        5.03       1.93       14.8 
##  5     5 Isabela        5.10       1.98       10.6 
##  6     6 Isabela        5.06       2.08       19.9 
##  7     7 Isabela        5.08       1.82       15.6 
##  8     8 Isabela        5.02       1.96        4.30
##  9     9 Isabela        4.92       2.04        9.48
## 10    10 Isabela        5.08       1.96        6.51
## # ... with 90 more rows
\end{verbatim}
...
##  1     1 Isabela beak_length  5.19
##  2     1 Isabela beak_width   1.97
##  3     1 Isabela body_weight NA   
##  4     2 Isabela beak_length NA   
##  5     2 Isabela beak_width   2.05
##  6     2 Isabela body_weight 10.6 
##  7     3 Isabela beak_length  5.09
##  8     3 Isabela beak_width   1.95
...
##  1     1 Isabela beak_length  5.19
##  2     1 Isabela beak_width   1.97
##  3     2 Isabela beak_width   2.05
##  4     2 Isabela body_weight 10.6 
##  5     3 Isabela beak_length  5.09
##  6     3 Isabela beak_width   1.95
##  7     3 Isabela body_weight 12.4 
##  8     4 Isabela beak_length  5.03
##  9     4 Isabela beak_width   1.93
## 10     5 Isabela beak_length  5.10
## # ... with 190 more rows
\end{verbatim}
...
##  1     1 Isabela beak_length    5.19
##  2     1 Isabela beak_width     1.97
##  3     1 Isabela body_weight -999   
##  4     2 Isabela beak_length -999   
##  5     2 Isabela beak_width     2.05
##  6     2 Isabela body_weight   10.6 
##  7     3 Isabela beak_length    5.09
##  8     3 Isabela beak_width     1.95
...
##  1     1 Isabela beak_length  5.19
##  2     1 Isabela beak_width   1.97
##  3     1 Isabela body_weight  1.97
##  4     2 Isabela beak_length  1.97
##  5     2 Isabela beak_width   2.05
##  6     2 Isabela body_weight 10.6 
##  7     3 Isabela beak_length  5.09
##  8     3 Isabela beak_width   1.95
...
##  1     1 Isabela beak_length  5.19     5     1  2019
##  2     1 Isabela beak_width   1.97     5     9  2020
##  3     1 Isabela body_weight NA       13     7  2020
##  4     2 Isabela beak_length NA        6     5  2019
##  5     2 Isabela beak_width   2.05    19     6  2019
##  6     2 Isabela body_weight 10.6      2     2  2020
##  7     3 Isabela beak_length  5.09    20     9  2020
##  8     3 Isabela beak_width   1.95    24     7  2019
##  9     3 Isabela body_weight 12.4      3     9  2020
## 10     4 Isabela beak_length  5.03    10     1  2020
## # ... with 290 more rows
\end{verbatim}
...
##       id island  variable    value date 
##    <int> <chr>   <chr>       <dbl> <chr>
##  1     1 Isabela beak_length  5.19 5    
##  2     1 Isabela beak_length  5.19 1    
##  3     1 Isabela beak_length  5.19 2019 
##  4     1 Isabela beak_width   1.97 5    
##  5     1 Isabela beak_width   1.97 9    
##  6     1 Isabela beak_width   1.97 2020 
##  7     1 Isabela body_weight NA    13   
##  8     1 Isabela body_weight NA    7    
##  9     1 Isabela body_weight NA    2020 
## 10     2 Isabela beak_length NA    6    
## # ... with 890 more rows
\end{verbatim}
...
##  6 Isabela beak_length     6 NA    19-11-2020
##  7 Isabela beak_length     7  5.08 29-6-2020 
##  8 Isabela beak_length     8  5.02 2-10-2020 
##  9 Isabela beak_length     9  4.92 17-6-2019 
## 10 Isabela beak_length    10 NA    16-10-2020
## # ... with 290 more rows
\end{verbatim}
...
To extract a set of variables (i.e.~columns), use the conveniently-named \texttt{select()}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine_subset <-}\StringTok{ }\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}
\NormalTok{    binomial, }
\NormalTok{    order, }
\NormalTok{    terrestrial, }
\NormalTok{    marine, }
\NormalTok{    freshwater, }
\NormalTok{    aerial}
\NormalTok{  )}
\NormalTok{phylacine_subset}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(family)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(genus, species, mass_g)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# A range of variables}
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(family}\OperatorTok{:}\NormalTok{terrestrial)}
\end{Highlighting}
\end{Shaded}
...
\texttt{select()} can also \emph{exclude} variables:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{binomial)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{(binomial}\OperatorTok{:}\NormalTok{species))}
\end{Highlighting}
\end{Shaded}
...
\texttt{select()} and \texttt{rename()} are pretty similar, and in fact, \texttt{select()} can also rename variables along the way:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\StringTok{"fam"}\NormalTok{ =}\StringTok{ }\NormalTok{family)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}
...
Conditional selection of observations is performed through \texttt{filter()}. This i sarguably the most useful function in the entire package. The syntax uses conditions involving the variables, just as you would use for \texttt{if} statements or \texttt{while} loops.
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(mass_g }\OperatorTok{>}\StringTok{ }\FloatTok{1e5}\NormalTok{) }\CommentTok{# 100 kg}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# living megafauna}
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(mass_g }\OperatorTok{>}\StringTok{ }\FloatTok{1e5}\NormalTok{, iucn_status }\OperatorTok{!=}\StringTok{ "EP"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Are there any flying mammals besides bats?}
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(aerial }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, order }\OperatorTok{!=}\StringTok{ "Chiroptera"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# That one species}
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(binomial }\OperatorTok{==}\StringTok{ "Homo_sapiens"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(mass_g }\OperatorTok{>}\StringTok{ }\FloatTok{1e3}\NormalTok{, mass_g }\OperatorTok{<}\StringTok{ }\FloatTok{1e5}\NormalTok{) }\CommentTok{# base}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(mass_g }\OperatorTok{%>%}\StringTok{ }\KeywordTok{between}\NormalTok{(}\FloatTok{1e3}\NormalTok{, }\FloatTok{1e5}\NormalTok{)) }\CommentTok{# dplyr}
\end{Highlighting}
\end{Shaded}
...
If instead of selecting observations based on conditions, you want to get the nth row, use \texttt{slice()}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# can also be used to exclude rows}
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{slice}\NormalTok{(}\OperatorTok{-}\DecValTok{2}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
You may also want the row number to be included as a variable, to be used as part of some condition or calculation. \texttt{tibble} is there for you:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phylacine }\OperatorTok{%>%}\StringTok{ }\NormalTok{tibble}\OperatorTok{::}\KeywordTok{rownames_to_column}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
